...
<head>
    <meta charset="UTF-8">
    <title>Paciente Actualizado - WarmLife</title>
    ...
    <style>
        ...
        .msg-ok { background:rgba(0,212,255,0.15); border:1px solid rgba(0,212,255,0.35); border-radius:12px; padding:14px 20px; margin-bottom:20px; color:#b8f5ff; font-weight:600; font-size:15px; }
...
<div class="result-box">
    <div class="msg-ok">✓ Paciente #<?=$id?> actualizado exitosamente.</div>
    <h3>Lista actualizada de pacientes:</h3>
    <?php mostrar_datos($conn); ?>
    <div class="acciones">
        <a href="Gestion.html" class="btn-accion btn-menu">← Volver al menú</a>
        <a href="formulario_actualizar.html" class="btn-accion btn-nuevo">Actualizar otro</a>
    </div>
</div>
</body>
</html>
